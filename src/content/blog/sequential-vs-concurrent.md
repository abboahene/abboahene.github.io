...
A **thread** is the smallest unit of execution is computer system. A single task(process) can be broken up into multiple **threads** and each would work on different parts of the same task.
